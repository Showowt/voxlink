...
export const metadata: Metadata = {
  ...
  description:
    "Break language barriers instantly. Free real-time voice translation between English and Spanish. Video calls, face-to-face conversations, and voice message translation. Works on any device.",
  ...
  openGraph: {
    ...
    description:
      "Break language barriers instantly. Free real-time voice translation between English and Spanish.",
    siteName: "VoxLink",
  ...
  twitter: {
    ...
    title: "VoxLink - Real-Time Voice Translation",
    description:
      "Break language barriers instantly. Free real-time voice translation.",
